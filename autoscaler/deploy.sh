...
# autoscaler vars
cf set-env rabbit-queue-autoscaler autoscaler_rabbitMq_applicationName hipy
cf set-env rabbit-queue-autoscaler autoscaler_rabbitMq_queueName autoscaler-demo
